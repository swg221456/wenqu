            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="bigdiv col-sx-12 col-sm-12 col-md-9 col-lg-8">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="热搜榜">
                                        <ItemTemplate>
                                            <div class="ddw">
                                                <a href="#">
                                                    <asp:Image ID="Image1" runat="server" ImageUrl='<%#"~/UploadPic/" +Eval("path") %>' CssClass="libpic" Height="135px" Width="203px" /></a>
                        ...
                        <div class="piccs hidden-xs">
                            ...
                            <div class="picqs">
                                ...
                                <a href="BookCity.aspx" class="aa1">
                                    <p>浪漫青春</p>
                                </a>
                            </div>
                            ...
                            <div class="picas">
                                ...
                                <a href="BookCity.aspx" class="aa2">
                                    <p>古代言情</p>
                                </a>
                            </div>
                    ...
                    <div class="bookrank hidden-sm hidden-xs hidden-md col-lg-2">
                        ...
                        <a href="BookCity.aspx">
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("ebookName") %>'></asp:Label></a>
                                        </ItemTemplate>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="阅读排行榜">
                                        <ItemTemplate>
                                            <%# Container.DataItemIndex + 1 %>.
                          <a href="BookCity.aspx">
                              <asp:Label ID="Label2" runat="server" Text='<%# Eval("bookName") %>'></asp:Label></a>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="ps_item" />
                                    </asp:TemplateField>
                                </Columns>
